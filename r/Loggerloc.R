...
write.csv(Loss_sites_25, "C:\\Users\\sscol\\OneDrive\\Desktop\\Logger\\otb-temp\\data\\loss_sites_2024.csv")
sg_sites_25<- as.data.frame(strata_eqprob_sg$sites_base)
write.csv(sg_sites_25, "C:\\Users\\sscol\\OneDrive\\Desktop\\Logger\\otb-temp\\data\\sg_sites_2024.csv")
